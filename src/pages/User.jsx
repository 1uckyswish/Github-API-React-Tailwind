      ...
      <div className="w-full mx-auto lg:w-10/12">
        ...
        <div className="grid grid-cols-1 mb-8 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 md:gap-8">
          <div className="mb-6 custom-card-image md:mb-0">
            <div className="shadow-l rounded-xl card image-full">
              <figure>
                <img src={avatar_url} alt="" />
              </figure>
              <div className="justify-end card-body">
                <h2 className="mb-0 text-white card-title">{name}</h2>
          ...
          <div className="col-span-2">
            <div className="mb-6">
              <h1 className="text-3xl card-title">
                {name}
                <div className="py-2.5 ml-2 mr-1 badge badge-success">{type}</div>
                {hireable && (
